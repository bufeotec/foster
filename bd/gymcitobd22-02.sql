...
-- Tiempo de generación: 22-02-2022 a las 16:39:47
...
(18, 2, '', 'Emerson Araujo Amat', '42161731', 'emer29.ara@gmail.com', 'San Antonio #2155', '', '938108238', '2022-02-22 08:13:26', 1);
...
(1, 1, 4, 1, 59, NULL, NULL, NULL, NULL, NULL, '100.00', '1999.00', '0.00', 1, '2022-02-15 18:56:12'),
...
INSERT INTO `suscripciones` (`id_suscripcion`, `id_usuario`, `id_cliente`, `id_horario`, `suscripcion_total`, `suscripcion_inicio`, `suscripcion_fin`, `suscripcion_fin_actual`, `suscripcion_costo`, `suscripcion_pagado`, `suscripcion_registro`, `suscripcion_estado`) VALUES
(1, 5, 13, 1, 1, '2022-02-21', '2022-03-20', '2022-03-20', 150.00, 150.00, '2022-02-21 18:40:26', 1);
...
(1, 1, 2, 'superadmin', '$2y$10$oPOOOgTUr4zIh511ATm/q.vzsAmxP.e2.vzyEbRn/1pzyWz2oXj0a', 'cesarjose@bufeotec.com', 'media/usuarios/usuario.jpg', 1, '2020-09-17 00:00:00', '2022-02-22 11:08:13', '2020-09-17 00:00:00'),
...
(5, 17, 4, 'admin', '$2y$10$Md2LaZj7AeYWN8vINIzmAuBonjrTeUIyitKXI9KThKSUxwOHX7RNm', 'adminpent@gmail.com', 'media/usuarios/usuario.jpg', 1, '2021-08-20 18:41:29', '2022-02-22 11:03:59', '2021-08-20 18:41:29');
...
--
ALTER TABLE `log_p`
  MODIFY `id_log_p` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `servicio_cliente`
  MODIFY `id_servicio_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `ventas_detalle`
  MODIFY `id_venta_detalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `ventas_detalle_pagos`
--
ALTER TABLE `ventas_detalle_pagos`
  MODIFY `id_venta_detalle_pago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
