    ...
    <section class="content" style="background-color: white;box-shadow: 10px 10px 15px #888888;border-radius: 30px; padding: 15px; margin: 20px; min-height: 500px">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div id="tabla_productos" style="display:none;"></div><br>
                <!--AQUI IRA LA NUEVA TABLA -->
                <div class="row">
                    <div class="col-lg-12" style="text-align: center; padding-bottom:5px; "><h3>LISTA DE PEDIDOS</h3></div>
                    <div class="col-lg-12">
                        <!-- DataTales Example -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        $a = 1;
                                        $venta_total=0;
                                        foreach ($produc_pv as $m){
                                            ?>
                                            <tr>
                                                <td><?= $a;?></td>
                                                <td><?= $m->pre_venta_nombre_producto;?></td>
                                                <td><?= $m->pre_venta_cantidad?></td>
                                                <td><?= $m->pre_venta_precio_unitario?></td>
                                                <td><?= $m->pre_venta_total?></td>
                                            </tr>
                                            <?php
                                            $venta_total = $venta_total + $m->pre_venta_total;
                                            $a++;
                                        }
                                        ?>
                                        <input type="hidden" id="venta_total_pv" name="venta_total_pv" value="<?=$venta_total?>">
                                        <tr><td  colspan="4" style="text-align: right;">TOTAL:</td><td style="background-color: #f9f17f"><b>S/.  <?php echo $venta_total;?></b></td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <label for="">DNI ó RUC:</label>
                        <input class="form-control" type="text" id="client_number" value="<?= $clientes_valor->cliente_numero?>" onchange="consultar_documento(this.value)">
                    </div>
                    <div class="col-lg-4" style="margin-top: 8px;display: none">
                        <br>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input class="form-control" type="text" id="client_name" value="<?= $clientes_valor->cliente_nombre?> <?= $clientes_valor->clientes_razonsocial?>">
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-4" style="display: none">
                        ...
                        <input class="form-control" type="text" id="client_telefono" value="<?= $clientes_valor->cliente_telefono?>">
                    </div>
                </div>
                <div class="row">
                    <!--<div class="col-lg-2"></div>-->
                ...
                <div class="row" style="text-align: center">
                    ...
                    <div class="col-lg-12">
                        <button type="button" id="btn_generarventa" class="btn btn-danger" style="padding: 1.0rem; font-size: 1.0rem; width: 40%" onclick="preguntar('¿Está seguro que desea realizar esta Venta?','realizar_venta_rapida_pv','Si','No')">
